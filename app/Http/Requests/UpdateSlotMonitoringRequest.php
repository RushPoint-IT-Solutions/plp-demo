...
class UpdateSlotMonitoringRequest extends FormRequest
{
    ...
    {
        $slotRoute = $this->route('slotMonitoring');
        $slotId = is_object($slotRoute) ? $slotRoute->id : $slotRoute;
        ...
        return [
            ...
            'subject' => [
                ...
                'string',
                'max:150',
                Rule::unique('slot_monitorings', 'subject')
