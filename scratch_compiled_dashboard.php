<?php $__env->startSection('title', 'PLP - Registrar Dashboard'); ?>
<?php $__env->startSection('page-title', 'DASHBOARD'); ?>
<?php $__env->startSection('body-class', 'page-registrar-dashboard'); ?>
...
<div class="rda-root">
    ...
    <div class="rda-banner">
        <div>
            <div class="rda-banner-greeting"><?php echo e($greeting); ?>, Registrar</div>
        ...
        <div class="rda-banner-pills">
            <div class="rda-banner-pill">
                <div class="rda-banner-pill-val"><?php echo e(number_format($studentCount)); ?></div>
                <div class="rda-banner-pill-lbl">Students</div>
            </div>
            <div class="rda-banner-pill">
                <div class="rda-banner-pill-val"><?php echo e(number_format($applicantCount)); ?></div>
                <div class="rda-banner-pill-lbl">Applicants</div>
            </div>
            <div class="rda-banner-pill">
                <div class="rda-banner-pill-val"><?php echo e($passRate); ?>%</div>
    ...
    <div class="rda-top">
        ...
        <div class="rda-kpi-grid">
            ...
            <div class="rda-kpi" style="--kc:#006837;">
                ...
                <div class="rda-kpi-label">Total Students<?php echo e($activeTermLabel !== '' ? ': ' . $activeTermLabel : ''); ?></div>
                <div class="rda-kpi-value"><?php echo e(number_format($studentCount)); ?></div>
                <div class="rda-kpi-meta"><?php echo e(number_format($maleCount)); ?> Male &bull; <?php echo e(number_format($femaleCount)); ?> Female</div>
                <div class="rda-kpi-tag <?php echo e($trendClass); ?>"><?php echo e($trendArrow); ?> <?php echo e($trendText); ?> vs last month</div>
            ...
            <div class="rda-kpi" style="--kc:#2563eb;">
                ...
                <div class="rda-kpi-value"><?php echo e(number_format($applicantCount)); ?></div>
                <div class="rda-kpi-meta">Current enrollment period</div>
                <div class="rda-kpi-tag neu"><?php echo e($departmentCount); ?> Dept<?php echo e($departmentCount !== 1 ? 's' : ''); ?></div>
            ...
            <div class="rda-kpi" style="--kc:#16a34a;">
                ...
                <div class="rda-kpi-value"><?php echo e(number_format($examPassed)); ?></div>
                <div class="rda-kpi-meta"><?php echo e(number_format($examFailed)); ?> failed &bull; <?php echo e(number_format($examPending)); ?> pending</div>
                <div class="rda-kpi-tag up"><?php echo e($passRate); ?>% pass rate</div>
            ...
            <div class="rda-kpi" style="--kc:#7c3aed;">
                ...
                <div class="rda-kpi-value"><?php echo e(number_format($graduateCount)); ?></div>
            ...
            <div class="rda-kpi" style="--kc:#d97706;">
                ...
                <div class="rda-kpi-value"><?php echo e(number_format($facultyCount)); ?></div>
                <div class="rda-kpi-meta"><?php echo e(number_format($facultyFullTimeCount)); ?> FULL-TIME &bull; <?php echo e(number_format($facultyPartTimeCount)); ?> PART-TIME</div>
            ...
            <div class="rda-kpi" style="--kc:#0891b2;">
                ...
                <div class="rda-kpi-value"><?php echo e(number_format($departmentCount)); ?></div>
        ...
        <div class="rda-quick">
            ...
            <a href="<?php echo e(route('registrar.process.application')); ?>" class="rda-qa" style="--qc:#dbeafe;">
            ...
            <a href="<?php echo e(route('registrar.process.exam-list')); ?>" class="rda-qa" style="--qc:#fef9c3;">
            ...
            <a href="<?php echo e(route('registrar.process.document-list')); ?>" class="rda-qa" style="--qc:#dcfce7;">
            ...
            <a href="<?php echo e(route('registrar.services.reports-admin.tagging-of-graduates')); ?>" class="rda-qa" style="--qc:#f3e8ff;">
            ...
            <a href="<?php echo e(route('registrar.services.grading-academic.scholastic-comments')); ?>" class="rda-qa" style="--qc:#fce7f3;">
            ...
            <a href="<?php echo e(route('registrar.registrar-menu.student-mgmt.student-enrollment')); ?>" class="rda-qa" style="--qc:#ffedd5;">
    ...
    <div class="rda-charts-main">
        ...
        <div class="rda-card">
            <div class="rda-card-hd">
                ...
                <div class="rda-card-badge"><?php echo e($activeTermLabel !== '' ? $activeTermLabel : 'Per semester'); ?></div>
            </div>
        ...
        <div class="rda-card" style="display:flex; flex-direction:column;">
            <div class="rda-card-hd">
                ...
                <div class="rda-card-badge"><?php echo e($activeTermLabel !== '' ? $activeTermLabel : 'Current semester'); ?></div>
            </div>
            <div class="rda-donut-wrap" style="flex:1; justify-content:center; padding:10px 0;">
                ...
                <div class="rda-donut-label">
                    <div class="rda-donut-lv"><?php echo e(number_format($studentCount)); ?></div>
            ...
            <div class="rda-legend">
                <div class="rda-legend-item">
                    ...
                    <span>Male — <?php echo e(number_format($maleCount)); ?><?php if($studentCount > 0): ?> (<?php echo e(round($maleCount/$studentCount*100,1)); ?>%)<?php endif; ?></span>
                </div>
                <div class="rda-legend-item">
                    <div class="rda-legend-dot" style="background:#4ade80;"></div>
                    <span>Female — <?php echo e(number_format($femaleCount)); ?><?php if($studentCount > 0): ?> (<?php echo e(round($femaleCount/$studentCount*100,1)); ?>%)<?php endif; ?></span>
                </div>
            </div>
        </div>
    ...
    <div class="rda-charts-bottom">
        ...
        <div class="rda-card" style="display:flex; flex-direction:column;">
            <div class="rda-card-hd">
                ...
                <div class="rda-card-badge"><?php echo e(now()->format('M j, Y')); ?></div>
            </div>
            <div class="rda-ann-feed" id="rdaAnnFeed" style="flex:1;">
                <?php $__empty_1 = true; $__currentLoopData = array_slice($dashAnn, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ann): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="rda-ann-row">
                    <div class="rda-ann-dot"></div>
                    <div class="rda-ann-body">
                        <div class="rda-ann-title" title="<?php echo e($ann['title']); ?>"><?php echo e($ann['title']); ?></div>
                        <div class="rda-ann-meta"><?php echo e($ann['timeLabel']); ?> &bull; <?php echo e($ann['audienceLabel']); ?></div>
                    </div>
...
(function () {
    ...
    var enrollPrograms = <?php echo json_encode(array_values(array_map(function ($row) { return (string) ($row['program'] ?? 'Program'); }, $enrollmentRows))); ?>;
    var enrollSemesters = <?php echo json_encode($enrollmentSemesters); ?>;
    var enrollRows = <?php echo json_encode($enrollmentRows); ?>;
    ...
    new Chart(document.getElementById('rdaGenderChart'), {
        ...
        data: {
            labels: ['Male', 'Female'],
            datasets: [{ data: [<?php echo e($maleCount); ?>, <?php echo e($femaleCount); ?>], backgroundColor: [G, G2], borderWidth: 0, hoverOffset: 6 }]
        },
        options: {
            cutout: '72%',
            plugins: {
...
<?php echo $__env->make('layouts.registrar', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>