...
Route::get('/docs/registrar-flow', function () {
...
Route::prefix('registrar')->name('registrar.')->middleware(['auth', 'force_password_reset', 'user.access'])->group(function () {
    ...
    Route::prefix('registrar-menu')->name('registrar-menu.')->group(function () {
        ...
        Route::prefix('student-management')->name('student-mgmt.')->middleware('course.scope.student')->group(function () {
            ...
            Route::post('/student-records/{student}/scholarships/unifast-toggle', 'Registrar\ScholarshipController@toggleUnifast')->name('student-records.scholarships.toggle-unifast')->middleware('throttle:30,1');
            ...
            Route::post('/student-records/{student}/withdraw', 'Registrar\RegistrarController@studentRecordWithdraw')->name('student-records.withdraw')->middleware('throttle:30,1');
            Route::post('/student-records/{student}/reactivate', 'Registrar\RegistrarController@studentRecordReactivateWithdrawn')->name('student-records.reactivate')->middleware('throttle:30,1');
        ...
        Route::prefix('forms')->name('forms.')->group(function () {
            ...
            Route::get('/late-application-leave-of-absence/{student}', 'Registrar\RegistrarController@formsLateApplicationLeaveAbsence')->name('late-application-leave-of-absence.show');
            Route::get('/late-application-leave-of-absence', 'Registrar\RegistrarController@formsLateApplicationLeaveAbsence')->name('late-application-leave-of-absence');
    ...
    Route::prefix('admin-tools')->name('admin-tools.')->group(function () {
        Route::prefix('system-config')->name('system-config.')->group(function () {
            ...
            Route::post('/configuration/signature/designation', 'Registrar\Services\AdminToolsController@configurationSignatureDesignationStore')->name('configuration.signature.designation.store');
