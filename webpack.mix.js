...
mix.js('resources/js/app.js', 'public/js')
   ...
   .js('resources/js/registrar-user-accounts.js', 'public/js')
   .js('resources/js/registrar-audit-trail.js', 'public/js')
   .js('resources/js/parent-grades.js', 'public/js')
   .js('resources/js/parent-student-profile.js', 'public/js')
   .js('resources/js/parent-calendar-events.js', 'public/js')
   .js('resources/js/parent-change-password.js', 'public/js')
   ...
   .sass('resources/sass/deans-honors.scss', 'public/css')
