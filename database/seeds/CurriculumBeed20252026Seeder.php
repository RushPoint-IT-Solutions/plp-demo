...
class CurriculumBeed20252026Seeder extends Seeder
{
    /**
     * Seeds the real "AY 2025-2026 Curriculum" for Bachelor of Elementary
     * Education, transcribed from PLP's official curriculum sheet: courses,
     ...
     *
     * Run with: php artisan db:seed --class=CurriculumBeed20252026Seeder
     *
     * @return void
     */
    private const PROGRAM_CODE = 'BEED';
    ...
    private const CURRICULUM = [
        '1st Year' => [
            'First Semester' => [
                ...
                ['code' => 'EDVE 201', 'name' => 'Good Manners and Right Conduct (Edukasyon sa Pagpapakatao)', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'EDFI 201', 'name' => 'Pagtuturo ng Filipino sa Elementarya 1 (Estraktura at Gamit ng Wikang Filipino)', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDMA 201', 'name' => 'Teaching Math in the Primary Grades', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDMT 201', 'name' => 'Content and Pedagogy for the Mother Tongue', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDTL 201', 'name' => 'Edukasyong Pantahanan at Pangkabuhayan I', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
        ...
        '2nd Year' => [
            'First Semester' => [
                ...
                ['code' => 'ED 104', 'name' => 'Foundation of Special and Inclusive Education', 'prereq' => ['ED 101'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'ED 105', 'name' => 'Facilitating Learner-Centered Teaching', 'prereq' => ['ED 101'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'ED 301', 'name' => 'Elective: Teaching Multi-Grade Classes', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'ED 401', 'name' => 'Guidance and Counseling', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDEN 201', 'name' => 'Teaching English in the Elementary Grades (Language Arts)', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDSC 201', 'name' => 'Teaching Science in Elementary Grades (Biology and Chemistry)', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'ED 106', 'name' => 'Assessment in Learning I', 'prereq' => ['ED 101'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'ED 107', 'name' => 'Building and Enhancing New Literacies Across the Curriculum', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDSS 201', 'name' => 'Teaching Social Studies in Primary Grades (Philippine History and Government)', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDEN 202', 'name' => 'Teaching English in the Elementary Grades Through Literature', 'prereq' => ['EDEN 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDFI 202', 'name' => 'Pagtuturo ng Filipino sa Elementarya II (Panitikan ng Pilipinas)', 'prereq' => ['EDFI 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDMA 202', 'name' => 'Teaching Math in Intermediate Grades', 'prereq' => ['EDMA 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDTL 202', 'name' => 'Edukasyong Pantahanan at Pangkabuhayan II', 'prereq' => ['EDTL 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
        ...
        '3rd Year' => [
            'First Semester' => [
                ...
                ['code' => 'ED 108', 'name' => 'Assessment in Learning II', 'prereq' => ['ED 106'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'ED 109', 'name' => 'Technology for Teaching and Learning I', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDSS 202', 'name' => 'Teaching Social Studies in Elementary Grades (Culture and Geography)', 'prereq' => ['EDSS 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDSC 202', 'name' => 'Teaching Science in the Elementary Grades (Physics, Earth and Space Science)', 'prereq' => ['EDSC 201'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDTT 201', 'name' => 'Technology for Teaching in Elementary Grades', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'EDAR 201', 'name' => 'Teaching Arts in the Elementary Grades', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDMU 201', 'name' => 'Teaching Music in Elementary Grades', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDPE 201', 'name' => 'Teaching PE and Health in the Elementary Grades', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'EDRE 201', 'name' => 'Research in Teaching', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ],
        ],
        '4th Year' => [
            'First Semester' => [
    ...
    public function run()
    {
        ...
        if (!$course) {
            $this->command->warn('CurriculumBeed20252026Seeder: program ' . self::PROGRAM_CODE . ' not found; skipping.');
            return;
        }
        ...
        foreach (array_keys(self::CURRICULUM) as $yearLabel) {
            if (!isset($yearBlockIds[$yearLabel])) {
                $this->command->warn("CurriculumBeed20252026Seeder: missing year_blocks row '{$yearLabel}'; skipping.");
                return;
            }
        }
        ...
        foreach (self::CURRICULUM as $yearLabel => $semesterRows) {
            ...
            foreach ($semesterRows as $semesterName => $courseRows) {
                if (!isset($semesterIds[$semesterName])) {
                    $this->command->warn("CurriculumBeed20252026Seeder: missing semesters row '{$semesterName}'; skipping this term.");
                    continue;
                }
        ...
        $this->command->info(
            'CurriculumBeed20252026Seeder: ' . $subjectsCreated . ' subject(s) created, '
