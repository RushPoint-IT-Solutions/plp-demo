...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->call([
            ...
            CurriculumBsa20232024Seeder::class,
            CurriculumBsba20232024Seeder::class,
            CurriculumBsent20232024Seeder::class,
            CurriculumBscs20252026Seeder::class,
            CurriculumBsit20252026Seeder::class,
            CurriculumBshm20252026Seeder::class,
            CurriculumBsedFil20252026Seeder::class,
            CurriculumBsedEng20252026Seeder::class,
            CurriculumBsedMath20252026Seeder::class,
            CurriculumBeed20252026Seeder::class,
            CurriculumBsece20252026Seeder::class,
