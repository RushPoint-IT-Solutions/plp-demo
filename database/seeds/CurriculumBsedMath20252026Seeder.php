...
class CurriculumBsedMath20252026Seeder extends Seeder
{
    /**
     * Seeds the real "AY 2025-2026 Curriculum" for Bachelor of Secondary
     * Education Major in Mathematics, transcribed from PLP's official
     ...
     *
     * Run with: php artisan db:seed --class=CurriculumBsedMath20252026Seeder
     *
     * @return void
     */
    private const PROGRAM_CODE = 'BSED-MATH';
    ...
    private const CURRICULUM = [
        '1st Year' => [
            'First Semester' => [
                ...
                ['code' => 'MAT 201', 'name' => 'History of Mathematics', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 202', 'name' => 'College and Advanced Algebra', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'MAT 203', 'name' => 'Trigonometry', 'prereq' => ['MAT 202'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 204', 'name' => 'Plane and Solid Geometry', 'prereq' => ['MAT 202'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 205', 'name' => 'Logic and Set Theory', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
        ...
        '2nd Year' => [
            'First Semester' => [
                ...
                ['code' => 'MAT 206', 'name' => 'Calculus 1 with Analytic Geometry', 'prereq' => ['MAT 203', 'MAT 205'], 'lec' => 4, 'lab' => 0, 'units' => 4, 'hours' => 4],
                ['code' => 'MAT 208', 'name' => 'Mathematics of Investment', 'prereq' => ['MAT 202'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 209', 'name' => 'Elementary Statistics and Probability', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 212', 'name' => 'Linear Algebra', 'prereq' => ['MAT 205'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'MAT 210', 'name' => 'Calculus 2', 'prereq' => ['MAT 206'], 'lec' => 4, 'lab' => 0, 'units' => 4, 'hours' => 4],
                ['code' => 'MAT 211', 'name' => 'Number Theory', 'prereq' => ['MAT 202', 'MAT 205'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 214', 'name' => 'Advanced Statistics', 'prereq' => ['MAT 209'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
        ...
        '3rd Year' => [
            'First Semester' => [
                ...
                ['code' => 'MAT 207', 'name' => 'Modern Geometry', 'prereq' => ['MAT 204', 'MAT 205'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 213', 'name' => 'Calculus 3', 'prereq' => ['MAT 210'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 215', 'name' => 'Principles and Strategies in Teaching Mathematics', 'prereq' => [], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 216', 'name' => 'Problem Solving, Mathematical Investigation and Modeling', 'prereq' => ['MAT 204', 'MAT 205'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
            ...
            'Second Semester' => [
                ...
                ['code' => 'MAT 217', 'name' => 'Abstract Algebra', 'prereq' => ['MAT 205'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 218', 'name' => 'Technology for Teaching and Learning 2 (Instrumentation and Technology in Mathematics)', 'prereq' => ['ED 108', 'ED 109', 'MAT 215'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
                ['code' => 'MAT 219', 'name' => 'Research in Mathematics', 'prereq' => ['MAT 214'], 'lec' => 4, 'lab' => 0, 'units' => 4, 'hours' => 4],
                ['code' => 'MAT 220', 'name' => 'Assessment and Evaluation in Mathematics', 'prereq' => ['MAT 214'], 'lec' => 3, 'lab' => 0, 'units' => 3, 'hours' => 3],
    ...
    public function run()
    {
        ...
        if (!$course) {
            $this->command->warn('CurriculumBsedMath20252026Seeder: program ' . self::PROGRAM_CODE . ' not found; skipping.');
            return;
        }
        ...
        foreach (array_keys(self::CURRICULUM) as $yearLabel) {
            if (!isset($yearBlockIds[$yearLabel])) {
                $this->command->warn("CurriculumBsedMath20252026Seeder: missing year_blocks row '{$yearLabel}'; skipping.");
                return;
            }
        }
        ...
        foreach (self::CURRICULUM as $yearLabel => $semesterRows) {
            ...
            foreach ($semesterRows as $semesterName => $courseRows) {
                if (!isset($semesterIds[$semesterName])) {
                    $this->command->warn("CurriculumBsedMath20252026Seeder: missing semesters row '{$semesterName}'; skipping this term.");
                    continue;
                }
        ...
        $this->command->info(
            'CurriculumBsedMath20252026Seeder: ' . $subjectsCreated . ' subject(s) created, '
