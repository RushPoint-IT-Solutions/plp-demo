...
/***/ "./resources/js/apply-basic-details.js":
/*!*********************************************!*\
  !*** ./resources/js/apply-basic-details.js ***!
  \*********************************************/
...
(function () {
  ...
  function getEnabledOptionButtons(menu) {
    return Array.prototype.filter.call(menu.querySelectorAll('.app-apply-select-option-btn'), function (button) {
      return !button.disabled;
    });
  }
  function setActiveOption(menu, optionButton, shouldFocus) {
    menu.querySelectorAll('.app-apply-select-option-btn').forEach(function (button) {
  ...
  function moveActiveOption(menu, step) {
    var buttons = getEnabledOptionButtons(menu);
    if (!buttons.length) {
      return null;
    }
    var active = menu.querySelector('.app-apply-select-option-btn.is-active');
  ...
  function openSelect(wrapper, trigger, menu, select) {
    ...
    setActiveOption(menu, selected, true);
  }
  ...
  function buildOptionButton(option, select, menu, currentText, wrapper, index) {
    ...
    item.className = 'app-apply-select-option';
    var button = document.createElement('button');
    button.type = 'button';
    button.className = 'app-apply-select-option-btn';
    button.textContent = option.textContent || '';
    button.id = select.id + '-custom-option-' + index;
  ...
  wrappers.forEach(function (wrapper) {
    var select = wrapper.querySelector('select.js-app-apply-enhance');
    var trigger = wrapper.querySelector('[data-select-trigger]');
    ...
    trigger.addEventListener('keydown', function (event) {
      ...
      if (event.key === 'Enter' || event.key === ' ') {
        ...
        commitOption(menu.querySelector('.app-apply-select-option-btn.is-active'), select, wrapper);
      }
    });
...
/***/ 1:
/*!***************************************************!*\
  !*** multi ./resources/js/apply-basic-details.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\micha\Desktop\OJT\plp-demo\resources\js\apply-basic-details.js */"./resources/js/apply-basic-details.js");
