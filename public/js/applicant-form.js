...
(function () {
  ...
  function createMcRow(id, doc, remarks, date, index) {
    ...
    return '<tr data-id="' + id + '" data-doc="' + doc + '" data-remarks="' + remarks + '" data-date="' + date + '">' + '<td>' + doc + '</td>' + '<td class="mc-remarks-cell">' + remarks + '</td>' + '<td class="mc-date-cell">' + formattedDate + '</td>' + '<td style="text-align: center;">' + '<div class="apst-action-btn" onclick="mcToggleActionMenu(' + index + ', event)" aria-label="Open row actions" title="Actions">' + '<span></span><span></span><span></span>' + '</div>' + '<div class="apst-dropdown mc-row-dropdown" id="mcMenu' + index + '">' + '<button type="button" class="mc-edit-action" onclick="mcOpenEdit(' + index + ')">' + '<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 1 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>' + 'Edit' + '</button>' + '<button type="button" class="apst-del-btn mc-delete-action" onclick="mcOpenDelete(' + index + ')">' + '<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>' + 'Delete' + '</button>' + '</div>' + '</td>' + '</tr>';
  }
})();
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\plp-demo\resources\js\applicant-form.js */"./resources/js/applicant-form.js");
