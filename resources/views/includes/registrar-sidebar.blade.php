    ...
    <nav class="sidebar-nav">
        ...
        <div class="sidebar-dropdown {{ request()->routeIs('registrar.registrar-menu.forms.*') ? 'open' : '' }}">
            ...
            <div class="sidebar-dropdown-menu">
                ...
                @if($canView('registrar.registrar-menu.forms.permission-cross-enroll'))<a href="{{ route('registrar.registrar-menu.forms.permission-cross-enroll') }}" class="sidebar-sublink {{ request()->routeIs('registrar.registrar-menu.forms.permission-cross-enroll') ? 'active' : '' }}">Application to Cross-Enroll</a>@endif
