...
@section('title', 'PLP - Applicant Help Center - Live Chat')
@section('body-class', 'page-registrar-help page-registrar-help-chat page-applicant-help')

@section('content')
<div class="reg-help-chat-page">
    <div class="reg-help-top-nav mb-2">
        <a href="{{ route('applicant.help.center') }}" class="reg-help-chat-back reg-help-back-btn" title="Back to Help Center">
