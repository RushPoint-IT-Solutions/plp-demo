...
@section('title', 'PLP - Applicant Help Center')
@section('body-class', 'page-registrar-help page-registrar-help-home page-applicant-help')

@section('content')
<div class="reg-help">
    <div class="reg-help-top-nav mb-2">
        <a href="{{ route('applicant.application-form') }}" class="reg-help-back-btn">
    ...
    <div class="reg-help-topic-grid" id="regHelpTopicGrid">
        @foreach($topics as $item)
            <a href="{{ route('applicant.help.topic', ['topic' => $item['slug']]) }}" class="reg-help-topic-card" data-help-keywords="{{ strtolower($item['title'] . ' ' . $item['subtitle']) }}">
    ...
    <div class="reg-help-bottom">
        ...
        <div class="reg-help-panel">
            ...
            <div class="reg-help-contact-grid">
                ...
                <a href="{{ route('applicant.help.live-chat') }}" class="reg-help-contact-card">
