...
@section('title', 'PLP - Parent Messaging')
...
@php
    ...
    $messages = [
        ...
        'drafts' => [
            ['sender' => 'You', 'type' => 'Draft', 'subject' => 'Parent inquiry about grades', 'date' => 'Mar 09, 2026'],
            ['sender' => 'You', 'type' => 'Draft', 'subject' => 'Request for schedule clarification', 'date' => 'Mar 07, 2026'],
        ],
        'sent' => [
            ['sender' => 'You', 'type' => 'Sent', 'subject' => 'Follow-up on student records', 'date' => 'Mar 11, 2026'],
            ['sender' => 'You', 'type' => 'Sent', 'subject' => 'Meeting request confirmation', 'date' => 'Mar 05, 2026'],
        ],
        'trash' => [
            ['sender' => 'Admissions', 'type' => 'Staff', 'subject' => 'Old information bulletin', 'date' => 'Feb 27, 2026'],
        ],
    ];
...
<div class="messaging-page msg-theme-lite">
    <div class="messaging-shell">
        <aside class="msg-sidebar">
            <a href="{{ route('parent.messaging', ['folder' => 'inbox']) }}" class="msg-nav-link {{ $folder === 'inbox' ? 'active' : '' }}">
            ...
            <a href="{{ route('parent.messaging', ['folder' => 'drafts']) }}" class="msg-nav-link {{ $folder === 'drafts' ? 'active' : '' }}">
                <span class="msg-nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('parent.messaging', ['folder' => 'sent']) }}" class="msg-nav-link {{ $folder === 'sent' ? 'active' : '' }}">
                <span class="msg-nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="{{ route('parent.messaging', ['folder' => 'trash']) }}" class="msg-nav-link {{ $folder === 'trash' ? 'active' : '' }}">
                <span class="msg-nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
