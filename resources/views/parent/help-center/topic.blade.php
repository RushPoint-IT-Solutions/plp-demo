...
@section('title', 'PLP - Parent Help Center - ' . strtoupper($topic['title']))
@section('body-class', 'page-registrar-help page-registrar-help-topic page-parent-help')

@section('content')
<div class="reg-help-topic-page">
    <div class="reg-help-top-nav mb-4">
        <a href="{{ route('parent.help.center') }}" class="reg-help-back-btn">
        ...
        <aside class="reg-help-side-panel">
            ...
            <div class="reg-help-contact-inline">
                ...
                <div class="reg-help-contact-inline-actions">
                    ...
                    <a href="{{ route('parent.help.live-chat') }}">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#submitTicketModal">
                        <svg class="reg-help-contact-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 5.5a2.5 2.5 0 0 0-5 0V7H8a2 2 0 0 0-2 2v2.5a2.5 2.5 0 0 1 0 5V19a2 2 0 0 0 2 2h2v-1.5a2.5 2.5 0 0 1 5 0V21h2a2 2 0 0 0 2-2v-2.5a2.5 2.5 0 0 1 0-5V9a2 2 0 0 0-2-2h-2V5.5z"/></svg>
                        Submit Ticket
                    </a>
                </div>
            </div>
...
@include('includes.submit-ticket-modal')
