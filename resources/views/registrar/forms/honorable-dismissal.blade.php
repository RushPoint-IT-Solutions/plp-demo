...
@php
    ...
    $hdSheetUrlTemplate = route('registrar.registrar-menu.forms.honorable-dismissal.sheet', ['student' => '__STUDENT__']);
    $hdBlankSheetUrl = route('registrar.registrar-menu.forms.honorable-dismissal.sheet');
    ...
    <div class="ga-page">
        ...
        <div class="app-filter-bar">
            ...
            <div class="frm-action-row">
                ...
                <button type="button" class="req-btn-save frm-action-btn" onclick="hdIssueAllSelected()">Issue All</button>
                @endif
...
window.hdSheetUrlTemplate = @json($hdSheetUrlTemplate);
window.hdBlankSheetUrl = @json($hdBlankSheetUrl);
</script>
