...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Grading Periods</h2>
        <p class="placeholder-text">This page is under development. Grading periods features will be available soon.</p>
    </div>
</div>
@endsection
