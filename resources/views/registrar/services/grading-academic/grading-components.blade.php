...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Grading Components</h2>
        <p class="placeholder-text">This page is under development. Grading components features will be available soon.</p>
    </div>
</div>
@endsection
