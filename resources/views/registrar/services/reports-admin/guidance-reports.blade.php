...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Guidance Reports</h2>
        <p class="placeholder-text">This page is under development. Guidance reports features will be available soon.</p>
    </div>
</div>
@endsection
