...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Tagging of Graduates</h2>
        <p class="placeholder-text">This page is under development. Tagging of graduates features will be available soon.</p>
    </div>
</div>
@endsection
