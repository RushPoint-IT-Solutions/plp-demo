    ...
    <div class="rfl-strength-meta-row">
        ...
        <div class="rfl-strength-meta-right">
            ...
            <div class="rfl-strength-line-row">
                ...
                <span class="rfl-strength-line-fill">{{ $printGeneratedAt->format('m/d/Y') }}</span>
            </div>
        </div>
    </div>

    <table class="rfl-strength-table">
        <thead>
            <tr>
        ...
        <tfoot>
            <tr>
                ...
                <td>{{ number_format((float) ($printTotals['total_hours'] ?? 0), 2) }}</td>
                <td>{{ (int) ($printTotals['students'] ?? 0) }}</td>
                <td></td>
            </tr>
        </tfoot>
    </table>
