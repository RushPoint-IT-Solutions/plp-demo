...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Student Discipline</h2>
        <p class="placeholder-text">This page is under development. Student discipline features will be available soon.</p>
    </div>
</div>
@endsection
