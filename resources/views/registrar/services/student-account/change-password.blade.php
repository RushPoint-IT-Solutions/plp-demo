...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Change Password</h2>
        <p class="placeholder-text">This page is under development. Change password features will be available soon.</p>
    </div>
</div>
@endsection
