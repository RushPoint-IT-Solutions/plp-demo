<div class="apc-card status-management-card p-0" style="border: none; box-shadow: none; background: transparent;">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="p-3 h-100" style="background: #ffffff; border-radius: 12px; border: 1px solid #d8e3dc; display: flex; flex-direction: column; justify-content: center; box-shadow: 0 2px 8px rgba(0, 104, 55, 0.05);">
        ...
        <div class="col-lg-8 col-md-12">
            <div class="p-3 h-100" style="background: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0;">
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="apc-field">
                            ...
                            <select class="apc-select w-100" id="updateStatusSelect" style="height: 38px; font-size: 0.85rem; font-weight: 500; color: #334155;">
        ...
        <div class="row g-3 mb-3">
            <div class="col-lg-6 col-md-12">
                <div class="apc-field">
                    ...
                    <select class="apc-select w-100" style="height: 38px; font-size: 0.85rem; color: #334155; font-weight: 500;">
    ...
    <div class="d-grid d-md-flex justify-content-md-end mt-3">
        <button type="button" class="apst-new-btn" style="min-width: 240px; height: 42px; font-size: 0.85rem; justify-content: center; border-radius: 6px; font-weight: 700; box-shadow: 0 4px 10px rgba(0, 104, 55, 0.1);">SAVE CHANGES</button>
    </div>
</div>
