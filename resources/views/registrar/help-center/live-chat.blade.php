...
@section('title', 'PLP - Help Center - Live Chat')
@section('body-class', 'page-registrar-help page-registrar-help-chat')

@section('content')
<div class="reg-help-chat-page">
    <div class="reg-help-top-nav mb-2">
        <a href="{{ route('registrar.help.center') }}" class="reg-help-chat-back reg-help-back-btn" title="Back to Help Center">
