...
@section('title', 'PLP - Help Center')
@section('body-class', 'page-registrar-help page-registrar-help-home')

@section('content')
<div class="reg-help">
    <div class="reg-help-top-nav mb-2" style="position: relative; z-index: 5;">
        <a href="{{ route('registrar.dashboard') }}" class="reg-help-back-btn">
    ...
    <div class="reg-help-topic-grid" id="regHelpTopicGrid">
        @foreach($topics as $item)
            <a href="{{ route('registrar.help.topic', ['topic' => $item['slug']]) }}" class="reg-help-topic-card" data-help-keywords="{{ strtolower($item['title'] . ' ' . $item['subtitle']) }}">
    ...
    <div class="reg-help-bottom">
        ...
        <div class="reg-help-panel">
            ...
            <div class="reg-help-contact-grid">
                ...
                <a href="{{ route('registrar.help.live-chat') }}" class="reg-help-contact-card">
                ...
                <a href="#" class="reg-help-contact-card" data-bs-toggle="modal" data-bs-target="#submitTicketModal">
