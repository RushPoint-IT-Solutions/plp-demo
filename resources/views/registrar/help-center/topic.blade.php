...
@section('title', 'PLP - Help Center - ' . strtoupper($topic['title']))
@section('body-class', 'page-registrar-help page-registrar-help-topic')

@section('content')
<div class="reg-help-topic-page">
    <div class="reg-help-top-nav mb-4">
        <a href="{{ route('registrar.help.center') }}" class="reg-help-back-btn">
        ...
        <aside class="reg-help-side-panel">
            ...
            <div class="reg-help-contact-inline">
                ...
                <div class="reg-help-contact-inline-actions">
                    ...
                    <a href="{{ route('registrar.help.live-chat') }}">
