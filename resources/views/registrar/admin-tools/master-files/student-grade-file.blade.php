...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Student Grade File</h2>
        <p class="placeholder-text">This page is under development. Student grade file features will be available soon.</p>
    </div>
</div>
@endsection
