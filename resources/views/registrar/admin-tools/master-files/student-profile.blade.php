...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Student Profile</h2>
        <p class="placeholder-text">This page is under development. Student profile features will be available soon.</p>
    </div>
</div>
@endsection
