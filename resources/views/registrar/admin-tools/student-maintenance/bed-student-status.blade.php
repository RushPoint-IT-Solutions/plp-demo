...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">BED Student Status</h2>
        <p class="placeholder-text">This page is under development. BED student status features will be available soon.</p>
    </div>
</div>
@endsection
