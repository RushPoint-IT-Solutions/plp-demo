...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Admission Config</h2>
        <p class="placeholder-text">This page is under development. Admission config features will be available soon.</p>
    </div>
</div>
@endsection
