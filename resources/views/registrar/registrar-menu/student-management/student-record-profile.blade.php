            ...
            <div class="srp-card">
                ...
                <div class="srp-card-body">
                    <div class="srp-fields cols3">
                        ...
                        <div class="srp-field"><label>Senior High School Year Graduated</label><input id="bg_senior_year" value="{{ $prof->senior_school_year_graduated ?? '' }}" placeholder="e.g. 2022"></div>
                    </div>
                </div>
            </div>
