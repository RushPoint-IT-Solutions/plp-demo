...
<div class="pf-page">
    <div class="placeholder-card">
        ...
        <h2 class="placeholder-title">Student Enrollment</h2>
        <p class="placeholder-text">This page is under development. Student enrollment features will be available soon.</p>
    </div>
</div>
@endsection
