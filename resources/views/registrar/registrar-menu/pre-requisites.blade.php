...
<div class="pf-page">
    ...
    <div class="pf-toolbar">
        <div class="pf-search-wrap">
            ...
            <input type="text" class="pf-search-input" placeholder="Search pre-requisites..." id="prSearch">
        </div>
    ...
    <div class="pf-table-wrap">
        <table class="pf-table" id="prTable">
            <thead>
                <tr>
                    <th>Subject Code</th>
                    <th>Subject Name</th>
            ...
            <tbody>
                <tr>
                    <td colspan="4" style="text-align:center;color:#999;padding:32px;">No pre-requisites configured yet.</td>
                </tr>
            </tbody>
        </table>
    </div>
